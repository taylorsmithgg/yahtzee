...
public class OneRoundOneRollYahtzee
{
    ...
    private static void getChoice()
    {
        ...
        switch(choice){
            ...
            case 2:
                ...
                String result = "The 5 rolls in non-decreasing order are: ";
                result.concat(getResultString());
    ...
    private static String getResultString(){
        ...
        for(int i = 0; i < rolls.length; i++){
            result = result.concat(String.valueOf(rolls[i]));
            if(i != rolls.length){
    ...
    public static void categories()
    {
        ...
        int evalResult = eval();
        System.out.println("Your score for the " + selection[rules - 1] + " category is: " + evalResult);
    }
    ...
    private static int eval(){
        ...
        switch(rules) {
            ...
            case 13:
                return 0;
            default:
                result = result.concat("The Yahtzee category is not legal for this roll: ");
                result = result.concat(getResultString());
